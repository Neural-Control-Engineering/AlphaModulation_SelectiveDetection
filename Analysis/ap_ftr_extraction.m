...
load(strcat(subject_path, '3387-20240121/regionMap_adjusted.mat'))
ftr_file = strcat(ftr_path, 'AP/subj--3387-20240702_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_adjusted.mat');
extToFtrAP(ext_path, expert_3387_session_ids, regMap, ftr_file)

load(strcat(subject_path, '3738-20240702/regionMap_adjusted.mat'))
ftr_file = strcat(ftr_path, 'AP/subj--3738-20240702_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_adjusted.mat');
extToFtrAP(ext_path, expert_3738_session_ids_v2, regMap, ftr_file)
...
% ftr_file = strcat(ftr_path, 'AP/subj--3738-20240702_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_g0.mat');
% extToFtrAP(ext_path, expert_3738_session_ids_v2, regMap, ftr_file)
