...
** TODOS:
*** DONE: read/cite Pala2022-ik (ipsilateral representations in S1)
...
* [2025-6-24 Tue] 
** TODOS 
*** DONE: shuffle versions for lick / no-lick 
...
*** DONE: fix figure panel references in discussion and results (especially for fig 3)
*** DONE: finalize figures
*** DONE: same sized dots for alpha power and phase mod fig 
...
** DONE: add that only 1.3% in correct incorrect shuffle were in <5th percentile 
** bimodal distribution for lick v no lick 

* [2025-7-5 Sat] - lick figs 
** DONE: add (red/blue) legend for figure 8 
** DONE: graphical abstract

* [2025-7-9 Wed] - finishing touches 
** TODOS 
*** DONE: regional lfp differences 
*** DONE: percent of trials w/ / w/out licks (rather than count)
*** DONE: replace figures 2 and 8 in text 
*** DONE: flesh out stats on LFPs in text 

* [2025-9-11 Thu] - received reviews 
** revisiting cell class classification 
*** plotting silhoutte scores for each session 

* [2025-9-16 Tue] - different significance computation 
** false discovery rate Benjamini-Hochberg procedure 
*** fdrBenjaminiHochberg.m - gives adjusted p-value for false detection rate of 0.01: 0.0043

* [2025-9-22 Mon] - distribution of alpha events 
*** no in AlphaModFigScripts/

* [2025-9-30 Tue] - 
** added other lfp sessions to lfpSpecGrmByOutcome.m 
*** need to add to lfpPowerByOutcome.m

* [2025-10-13 Mon] - remaking figures 
** phaseModSummaries.m 
*** DONE: need to get running without phase mod striatum rs 
** lick raster done 

* [2025-10-14 Tue] 
** BAD SESSION: 10162 - 09/15/25

* [2025-10-20 Mon] - jackkife periodic analysis 
** in lfpPowerByOutcome.m 
ps = zeros(1,size(pparams_pfc_hit,1));
for i = 1:size(pparams_pfc_hit,1)
