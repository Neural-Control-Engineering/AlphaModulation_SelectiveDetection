...
ylim([115,195]); xlim([-0.1,0.8])
xlabel('Time (s)')
ylabel('Layer')
***** 3738 - need to clean up artifacts 
session_ids = {'date--2024-07-17_subj--3738-20240702_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_g0.mat', ...
    'date--2024-07-16_subj--3738-20240702_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_g0.mat', ...
    'date--2024-07-15_subj--3738-20240702_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_g0.mat', ...
    'date--2024-07-13_subj--3738-20240702_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_g0.mat', ...
    'date--2024-07-12_subj--3738-20240702_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_g0.mat'};
time = linspace(-3,5,4000);
csd = {};
f0 = 0.1; f1 = 30;
d = designfilt('bandpassiir', ...
...
for s = 1:length(session_ids)
    ...
    colorbar(); clim([-15,15]); colormap('jet'); set(gca, 'YDir', 'normal'); ylim([115,185]); xlim([1400,2000])
end 
csd_mat = zeros(190,3999,length(csd));
for i = 1:length(csd)
    csd_mat(:,:,i) = csd{i}(:,1:3999);
end
figure(); imagesc(mean(csd_mat,3)); colorbar(); clim([-15,15]); colormap('jet'); set(gca, 'YDir', 'normal'); ylim([115,185]); xlim([1400,2000])
