...
**** TODO: rerun ap_ftr_extraction.m 
...
cells.
** TODOS:
*** TODO: autocorrelograms for each neuron 
**** sample code 
...
excld_file = 'ExcldInds/subj--3755-20240828_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_g0_excld_inds.mat';
...
**** example code 
load ~/neuralctrl/projects/nCORTEx/Project_Selective-Attention/Experiments/SELECT_DETECT/Data/FTR/LFP/date--2024-07-12_subj--3738-20240702_geno--Dbh-Cre-x-Gq-DREADD_npxls--R-npx10_phase--phase3_g0.mat
time = linspace(-3,5,4000);
mat = cell2mat(lfp_session.left_trigger_aligned_erp);
mat = mat - nanmean(mat(:,time < 0),2);
mat = mat(2:2:385,:);
csd = computeCSD(mat, (3.84/13/1000));
figure(); imagesc(csd(2:end-2,:)); clim([-10,10])
**** avg across sessions 
***** 3387
addpath(genpath('./'))
init_paths;
...
figure('Position', [489 1254 403 547]); hold on; 
...
title('Mouse 1')
***** 3738 - need to clean up artifacts 
addpath(genpath('./'))
init_paths;
...
for s = 1:length(session_ids)
    ...
    csd{s} = computeCSD(mat, (3.84/13/1000));
    % figure(); imagesc(csd{s}); 
    % colorbar(); clim([-15,15]); colormap('jet'); set(gca, 'YDir', 'normal'); ylim([100,200]); xlim([1400,2000])
end 
