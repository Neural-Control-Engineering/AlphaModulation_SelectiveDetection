...
correct_ptiles = [];
for ind = 61:70
    correct = [ap_session(ind,:).spon_alpha_spike_phases_hit{1}, ap_session(ind,:).spon_alpha_spike_phases_cr{1}];
    incorrect = [ap_session(ind,:).spon_alpha_spike_phases_miss{1}, ap_session(ind,:).spon_alpha_spike_phases_fa{1}];
    shuff_p = [];
