...
bar([2,5,8,11,14,17], ...
    ...
    nanmean(striatum_rs_fracs_lick), nanmean(striatum_fs_fracs_lick)], 0.3, ...
...
bar([1,4,7,10,13,16], ...
    ...
    nanmean(striatum_rs_fracs_nolick), nanmean(striatum_fs_fracs_nolick)], 0.3, ...
...
bar([2,5,8,11,14,17], ...
    ...
    nanmean(striatum_rs.pmi_lick), nanmean(striatum_fs.pmi_lick)], 0.3, ...
    'EdgeColor', 'k', 'FaceColor', 'b')
bar([1,4,7,10,13,16], ...
    [nanmean(s1_rs.pmi_nolick), nanmean(s1_fs.pmi_nolick), ...
    nanmean(pfc_rs.pmi_nolick), nanmean(pfc_fs.pmi_nolick), ...
    nanmean(striatum_rs.pmi_nolick), nanmean(striatum_fs.pmi_nolick)], 0.3, ...
    'EdgeColor', 'k', 'FaceColor', 'r')
errorbar([2,5,8,11,14,17], ...
    [nanmean(s1_rs.pmi_lick), nanmean(s1_fs.pmi_lick), ...
    nanmean(pfc_rs.pmi_lick), nanmean(pfc_fs.pmi_lick), ...
...
bar([2,5,8,11,14,17], ...
    ...
    nanmean(cellfun(@nanmean, out.striatum_rs_all_lick_frs)), nanmean(cellfun(@nanmean, out.striatum_fs_all_lick_frs))], 0.3, ...
    'EdgeColor', 'k', 'FaceColor', 'b')
bar([1,4,7,10,13,16], ...
    ...
    nanmean(cellfun(@nanmean, out.striatum_rs_all_no_lick_frs)), nanmean(cellfun(@nanmean, out.striatum_fs_all_no_lick_frs))], 0.3, ...
    'EdgeColor', 'k', 'FaceColor', 'r')
errorbar([2,5,8,11,14,17], ...
    [nanmean(cellfun(@nanmean, out.s1_rs_all_lick_frs)), nanmean(cellfun(@nanmean, out.s1_fs_all_lick_frs)), ...
    nanmean(cellfun(@nanmean, out.pfc_rs_all_lick_frs)), nanmean(cellfun(@nanmean, out.pfc_fs_all_lick_frs)), ...
...
%     nanmean(striatum_rs.mses_lick), nanmean(striatum_fs.mses_lick)], 0.3, ...
%     'EdgeColor', 'k', 'FaceColor', 'b')
% bar([1,4,7,10,13,16], ...
%     [nanmean(s1_rs.mses_nolick), nanmean(s1_fs.mses_nolick), ...
%     nanmean(pfc_rs.mses_nolick), nanmean(pfc_fs.mses_nolick), ...
%     nanmean(striatum_rs.mses_nolick), nanmean(striatum_fs.mses_nolick)], 0.3, ...
%     'EdgeColor', 'k', 'FaceColor', 'r')
% errorbar([2,5,8,11,14,17], ...
%     [nanmean(s1_rs.mses_lick), nanmean(s1_fs.mses_lick), ...
%     nanmean(pfc_rs.mses_lick), nanmean(pfc_fs.mses_lick), ...
...
bar([2,5,8,11,14,17], ...
    ...
    circ_mean(striatum_rs_theta_bars_lick), circ_mean(striatum_fs_theta_bars_lick)], 0.3, ...
    'EdgeColor', 'k', 'FaceColor', 'b')
bar([1,4,7,10,13,16], ...
    ...
    circ_mean(striatum_rs_theta_bars_nolick), circ_mean(striatum_fs_theta_bars_nolick)], 0.3, ...
    'EdgeColor', 'k', 'FaceColor', 'r')
errorbar([2,5,8,11,14,17], ...
    [circ_mean(s1_rs_theta_bars_lick), circ_mean(s1_fs_theta_bars_lick), ...
    circ_mean(pfc_rs_theta_bars_lick), circ_mean(pfc_fs_theta_bars_lick), ...
