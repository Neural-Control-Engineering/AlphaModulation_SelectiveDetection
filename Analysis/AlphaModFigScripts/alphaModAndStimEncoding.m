...
plot(zeros(length(s1_unmod_rs_evoked_cr),1)+8+(rand(length(s1_ummod_rs_evoked_cr),1)-0.5)*-0.3, s1_ummod_rs_evoked_cr, 'k.', 'MarkerSize', 0.1)
...
plot(zeros(length(s1_unmod_fs_evoked_cr),1)+8+(rand(length(s1_ummod_fs_evoked_cr),1)-0.5)*-0.3, s1_ummod_fs_evoked_cr, 'k.', 'MarkerSize', 0.1)
...
plot(zeros(length(pfc_unmod_rs_evoked_cr),1)+8+(rand(length(pfc_ummod_rs_evoked_cr),1)-0.5)*-0.3, pfc_ummod_rs_evoked_cr, 'k.', 'MarkerSize', 0.1)
violinplot(8, pfc_unmod_rs_evoked_cr, 'FaceColor', 'r')
plot(zeros(length(pfc_mod_rs_evoked_fa),1)+10+(rand(length(pfc_mod_rs_evoked_fa),1)-0.5)*-0.3, 'k.', pfc_mod_rs_evoked_fa, 'MarkerSize', 0.1)
...
plot(zeros(length(pfc_unmod_fs_evoked_cr),1)+8+(rand(length(pfc_ummod_fs_evoked_cr),1)-0.5)*-0.3, pfc_ummod_fs_evoked_cr, 'k.', 'MarkerSize', 0.1)
...
plot(zeros(length(striatum_unmod_rs_evoked_cr),1)+8+(rand(length(striatum_ummod_rs_evoked_cr),1)-0.5)*-0.3, striatum_ummod_rs_evoked_cr, 'k.', 'MarkerSize', 0.1)
...
plot(zeros(length(striatum_unmod_fs_evoked_cr),1)+8+(rand(length(striatum_ummod_fs_evoked_cr),1)-0.5)*-0.3, striatum_ummod_fs_evoked_cr, 'k.', 'MarkerSize', 0.1)
