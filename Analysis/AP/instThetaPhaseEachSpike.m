function out = instThetaPhaseEachSpike(ap_data, lfp_data)
    out = ap_data;
    for t = 1:size(ap_data,1)
        ...
        out(t,:).spiking_data{1} = [out(t,:).spiking_data{1}, table(phases, 'VariableNames', {'spike_theta_phase'})];
    end
end