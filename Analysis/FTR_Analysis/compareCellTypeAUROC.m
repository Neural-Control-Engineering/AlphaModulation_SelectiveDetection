function compareCellTypeAUROC(ap_session1, ap_session2, ttl, visualize, out_path)
    ...
    for r = 1:length(regions)
        ...
        for i = 1:length(cell_types)
            ...
            errs1(i) = std(cell2mat(ct1.auROC)) / sqrt(size(ct1,1));
        ...
        fname = sprintf('%s_%s_auroc_comparison', region, ttl)
