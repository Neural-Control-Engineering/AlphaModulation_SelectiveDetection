function compareRegionalCellTypeZscoreFRs(ap_session1, ap_session2, signals, regions, ttl, visualize, out_path)
    ...
    for i = 1:length(cell_types)
        ...
        unifyYLimits(fig);
        if out_path
            fname = sprintf('%s_%s_zscore_firing_rates_comparison', lower(ttl), cell_type);
