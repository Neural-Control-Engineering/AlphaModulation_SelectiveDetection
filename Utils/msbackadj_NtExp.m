function Y = msbackadj_NtExp(X,Y,varargin)
%% Adjusted by Kunpeng Yu for project: Neurotransmitter_Exploration
% return "Y(:,ns) = (Y(:,ns) - b)./b" instead of "Y(:,ns) = (Y(:,ns) - b)"
...
%
%
%   See also MSALIGN, MSHEATMAP, MSLOWESS, MSNORM,
